...
- 修改 docs/ 前，参考 dsh 技能的设计手法（`dsh-doc-standards`、`dsh-prose-standard`、`dsh-trim-cot-leakage`、`dsh-archive-agent-notes`）；只借手法，不搬三语、不搬脚本门禁。
- Agent Notes 规则见 `notes/README.md`。
